...
public class Config {
    ...
    public static List<ApiScheme.dcOption_> getTelegramDcs() {
        List<ApiScheme.dcOption_> dcOptionTelegram = new ArrayList<>();
        ApiScheme.dcOption_ dcOption1 = new ApiScheme.dcOption_();
        dcOption1.ip_address = "149.154.175.53";
        dcOption1.port = 443;
        dcOption1.id = 1;

        ApiScheme.dcOption_ dcOption12 = new ApiScheme.dcOption_();
        ...
        ApiScheme.dcOption_ dcOption3 = new ApiScheme.dcOption_();
        dcOption3.ip_address = "149.154.175.100";
        dcOption3.port = 443;
        dcOption3.id = 3;

        ApiScheme.dcOption_ dcOption4 = new ApiScheme.dcOption_();
        dcOption4.ip_address = "149.154.167.91";
        dcOption4.port = 443;
        dcOption4.id = 4;

        ApiScheme.dcOption_ dcOption5 = new ApiScheme.dcOption_();
    ...
    public static List<ApiScheme.dcOption_> getTelegramTestDcs() {
        List<ApiScheme.dcOption_> dcOptions = new ArrayList<>();
    ...
    public static List<ApiScheme.dcOption_> getLocalDcs() {
        List<ApiScheme.dcOption_> dcOptionLocal = new ArrayList<>();
        ApiScheme.dcOption_ dcOption1 = new ApiScheme.dcOption_();
