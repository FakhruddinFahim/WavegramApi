...
public class Config {
    ...
    public static List<MTDcOption> getTelegramDcs() {
        List<MTDcOption> dcOptionTelegram = new ArrayList<>();
        MTDcOption dcOption1 = new MTDcOption();
        dcOption1.ip_address = "149.154.175.53";
        dcOption1.port = 443;
        dcOption1.id = 1;

        MTDcOption dcOption12 = new MTDcOption();
        dcOption12.ip_address = "2001:0b28:f23d:f001:0000:0000:0000:000a";
        dcOption12.port = 443;
        dcOption12.id = 1;
        dcOption12.ipv6 = true;

        MTDcOption dcOption2 = new MTDcOption();
        dcOption2.ip_address = "149.154.167.51";
        dcOption2.port = 443;
        dcOption2.id = 2;

        MTDcOption dcOption3 = new MTDcOption();
        dcOption3.ip_address = "149.154.175.100";
        dcOption3.port = 443;
        dcOption3.id = 3;

        MTDcOption dcOption4 = new MTDcOption();
        dcOption4.ip_address = "149.154.167.91";
        dcOption4.port = 443;
        dcOption4.id = 4;

        MTDcOption dcOption5 = new MTDcOption();
    ...
    public static List<MTDcOption> getTelegramTestDcs() {
        List<MTDcOption> dcOptions = new ArrayList<>();
    ...
    public static List<MTDcOption> getLocalDcs() {
        List<MTDcOption> dcOptionLocal = new ArrayList<>();
        MTDcOption dcOption1 = new MTDcOption();
