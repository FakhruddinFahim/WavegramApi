        ...
        if (file.exists()) {
            try {
                ...
                if (secretChat.encryptedChat instanceof ApiScheme.encryptedChatWaiting encryptedChatWaiting) {
                    accessHash = encryptedChatWaiting.access_hash;
                    adminId = encryptedChatWaiting.admin_id;
                    participantId = encryptedChatWaiting.participant_id;
                    ...
                    accessHash = encryptedChatRequested.access_hash;
                    ...
                    keyFingerprint = encryptedChat2.key_fingerprint;
                }
