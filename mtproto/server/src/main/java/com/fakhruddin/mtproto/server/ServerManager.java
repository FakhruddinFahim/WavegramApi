...
public abstract class ServerManager {
     ...
     */
    public abstract List<MTProtoScheme.future_salt> getSalts(long authKeyId, int limit);
     ...
     * @param salts salts
     */
    public abstract void setSalts(long authKeyId, List<MTProtoScheme.future_salt> salts);
